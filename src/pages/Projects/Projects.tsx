...
const categories = [
  ...
  { id: 'fullhome', label: 'Whole House Renovation' },
...
const photos = [
  { id: 1, cat: 'kitchen', label: 'Kitchen Remodeling', img: 'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/IMG_0743-1-scaled.jpg', route: '/kitchen' },
  { id: 2, cat: 'bathroom', label: 'Bathroom Renovation', img: 'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/photo_2025-10-14_00-00-36.jpg', route: '/bathroom' },
  { id: 3, cat: 'fullhome', label: 'Whole House Renovation', img: 'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/IMG_8985-scaled-1.webp', route: '/fullhome' },
  { id: 4, cat: 'flooring', label: 'Flooring', img: 'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/photo_2025-10-14_00-04-49.jpg', route: '/flooring' },
  { id: 5, cat: 'painting', label: 'Painting', img: 'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/IMG_1134.jpg', route: '/painting' },
  { id: 6, cat: 'commercial', label: 'Commercial', img: 'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/IMG_0681.jpg', route: '/commercial' },
]
      ...
      <section style={{ padding: '72px 48px' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h1 style={{ color: '#1A305E', fontSize: '40px', fontWeight: 800, marginBottom: '12px' }}>Project Gallery</h1>
            <p style={{ color: '#5A6A7A', fontSize: '16px', maxWidth: '560px', margin: '0 auto', lineHeight: 1.7 }}>Browse our completed projects. Click any photo to see the full gallery for that category.</p>
          </div>
