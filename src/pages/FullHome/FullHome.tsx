...
const photos = [
  'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/IMG_8985-scaled-1.webp',
  'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/IMG_5879-1.jpg',
  'https://touched-salmon.10web.cloud/wp-content/uploads/2026/03/IMG_6837-1.jpg',
]
      ...
      <section style={{ padding: '72px 48px' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h1 style={{ color: '#1A305E', fontSize: '40px', fontWeight: 800, marginBottom: '12px' }}>Whole House Renovation</h1>
            <p style={{ color: '#5A6A7A', fontSize: '16px', maxWidth: '560px', margin: '0 auto', lineHeight: 1.7 }}>Complete gut renovations from design to final walkthrough across NY & NJ.</p>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '16px', marginBottom: '48px' }}>
            {photos.map((src, i) => (
              <div key={i} style={{ borderRadius: '10px', overflow: 'hidden', border: '1px solid #E0D8CC', aspectRatio: '4/3' }}>
                <img src={src} alt="Full home renovation" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            ))}
          </div>
          <div style={{ background: '#1A305E', borderRadius: '12px', padding: '48px', textAlign: 'center' }}>
            <h2 style={{ color: '#fff', fontSize: '28px', fontWeight: 800, marginBottom: '12px' }}>Ready for a Full Renovation?</h2>
